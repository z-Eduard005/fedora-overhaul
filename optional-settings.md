...
1. `sudo nano /etc/default/grub`:  
  1.1. Make the system start faster: `GRUB_TIMEOUT=3`  
  1.2. Add a custom refresh rate:  
    ```
    # additional refresh rate
    GRUB_CMDLINE_LINUX_DEFAULT="quiet video=HDMI-A-1:1920x1080@75"
    ```
    1.3. Always run this after updating the GRUB file to save changes: `sudo grub2-mkconfig -o /boot/grub2/grub.cfg`  
